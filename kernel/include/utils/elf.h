 ...
 *      Author: joaquin
 *
 *  Original source: https://github.com/klange/toaruos/blob/master/kernel/include/elf.h
 */

#ifndef KERNEL_INCLUDE_UTILS_ELF_H_
#define KERNEL_INCLUDE_UTILS_ELF_H_
...
#endif /* KERNEL_INCLUDE_UTILS_ELF_H_ */
